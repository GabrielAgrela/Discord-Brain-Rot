...
- **Three-way branching** after transcription:
    ...
    3. **No command** (e.g. "ventura, you are useless"): the bot routes the transcript to **OpenRouter** (Qwen Coder model) which generates an angry André Ventura parody reply in European Portuguese with ElevenLabs square-bracket performance tags. The reply is sent to **ElevenLabs Ventura TTS** and played back.
