...
class ReplayButton(Button):
    ...
    async def callback(self, interaction):
        ...
        self.bot_behavior.add_entry(interaction.user.name, "replay_sound", self.audio_file)
...
class FavoriteButton(Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        self.bot_behavior.add_entry(interaction.user.name, "favorite_sound", self.audio_file)
...
class BlacklistButton(Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        self.bot_behavior.add_entry(interaction.user.name, "blacklist_sound", self.audio_file)
...
class ChangeSoundNameButton(Button):
    ...
    async def callback(self, interaction):
        ...
        if new_name:
            ...
            self.bot_behavior.add_entry(interaction.user.name, "change_sound_name", self.sound_name)
...
class ListBlacklistButton(Button):
    ...
    async def callback(self, interaction):
        ...
        self.bot_behavior.add_entry(interaction.user.name, "list_blacklisted_sounds")
...
class ListSoundsButton(Button):
    ...
    async def callback(self, interaction):
        ...
        self.bot_behavior.add_entry(interaction.user.name, "list_sounds")
...
class ListTopSoundsButton(Button):
    ...
    async def callback(self, interaction):
        ...
        self.bot_behavior.add_entry(interaction.user.name, "list_top_sounds")
...
class ListTopUsersButton(Button):
    ...
    async def callback(self, interaction):
        ...
        self.bot_behavior.add_entry(interaction.user.name, "list_top_users")
...
class ListLastScrapedSoundsButton(Button):
    ...
    async def callback(self, interaction):
        ...
        self.bot_behavior.add_entry(interaction.user.name, "list_last_scraped_sounds")
